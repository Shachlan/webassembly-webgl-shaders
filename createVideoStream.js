 ...
 */
function frame(video, context, texture, callback) {
  ...
  requestAnimationFrame(() => frame(video, context, texture, callback));
}
 ...
 */
export function createVideoStreamFromElement(
  videoElement,
  context,
  frameCallback
) {
  ...
  requestAnimationFrame(() =>
    frame(videoElement, context, texture, frameCallback)
  );
  ...
  return RegisterNativeTextureId(texture);
}
